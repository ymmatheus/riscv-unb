...
\section{Simulador}
	...
	Na figura \ref{fig:simulator_results} é mostrado um exemplo dos resultados gerados pelo simulador implementado no projeto.

	\begin{figure}[h]
	  \includegraphics[width=\linewidth]{img/simulator_results.png}
	  \caption{Resultados do simulador.}
	  \label{fig:simulator_results}
	\end{figure}
